...
/**
 * شاشة تسجيل الدخول - Login Activity (Ultimate Edition)
 * توفر خيار تسجيل دخول سريع عبر جوجل ودخول مباشر للمنصة الشاملة.
 */
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // التحقق من حالة تسجيل الدخول المسبقة لضمان الاستمرارية
        ...
        btnGoogleLogin.setOnClickListener {
            // محاكاة تسجيل دخول جوجل بضغطة واحدة (One-Tap Sign-in)
            savePersistentSession("جوجل_مستخدم_جديد")
            Toast.makeText(this, "تم تسجيل الدخول عبر جوجل بنجاح!", Toast.LENGTH_LONG).show()
            startActivity(Intent(this, MainActivity::class.java))
            finish()
        }
